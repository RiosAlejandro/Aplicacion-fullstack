        ...
        <div className="shadow-inner w-2/5 pt-12 flex flex-col items-center">
          ...
          <form>
            ...
            <div className="mt-6 flex justify-center">
              <button type="button" className="rounded-full uppercase font-semibold text-white px-6 py-2 bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500">
                Register
              </button>
            </div>
